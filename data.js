...
const ZONES = {
  ...
  'isla-cedros':       { name: 'Isla Cedros',               coast: 'Pacific',        lat: 28.17, lng: -115.19, launch: 'Fly-in only (Biosphere Reserve) — Cessna Caravan from Tijuana/Ensenada to the island; 27–28 ft super-pangas from Cedros village. Cedros Outdoor Adventures runs all-inclusive lodge packages.' },
...
const SPECIES_INFO = {
  ...
  // Billfish
  'black-marlin':       { name: 'Black Marlin',          img: 'fish/black-marlin.jpg',          season: 'Jun–Nov',                range: ['cabo','san-jose-del-cabo','east-cape','la-ribera','los-barriles','la-paz'] },
  'sailfish':           { name: 'Sailfish',              img: 'fish/sailfish.jpg',              season: 'Jun–Nov',                range: ['cabo','san-jose-del-cabo','east-cape','la-ribera','los-barriles','la-paz','mag-bay'] },
  ...
  'skipjack-tuna':      { name: 'Skipjack Tuna',         img: 'fish/skipjack-tuna.jpg',         season: 'Feb–Nov',                range: [..._SOC_SOUTH,'loreto','puerto-escondido'] },
  // Bass
  'sand-bass':          { name: 'Barred Sand Bass',      img: 'fish/sand-bass.jpg',             season: 'May–Sep',                range: ['popotla','ensenada','colonet','san-quintin','punta-baja','isla-cedros'] },
  ...
  'yellow-snapper':     { name: 'Yellow Snapper',        img: 'fish/yellow-snapper.jpg',        season: 'Apr–Jul',                range: [..._SOC_SOUTH,..._SOC_CENTRAL,'mag-bay'] },
  'barred-pargo':       { name: 'Barred Pargo',          img: 'fish/barred-pargo.jpg',          season: 'Apr–Jul',                range: [..._SOC_SOUTH,'loreto','puerto-escondido','agua-verde','san-evaristo','punta-chivato'] },
  'dog-snapper':        { name: 'Dog Snapper (Pargo Prieto)', img: 'fish/dog-snapper.jpg',      season: 'Jun–Oct',                range: [..._SOC_SOUTH,'loreto','puerto-escondido'] },
  ...
  'pompano':            { name: 'Gafftopsail Pompano',   img: 'fish/pompano.jpg',               season: 'Jun–Oct',                range: ['la-paz','la-ventana','los-barriles','east-cape','pescadero','todos-santos'] },
